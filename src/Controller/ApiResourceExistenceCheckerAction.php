...
{
    public function __construct(private readonly SerializerInterface $serializer, private readonly IriConverterInterface $iriConverter, private readonly ValidatorInterface $validator)
    {
    }
